...
<body>
    ...
    <div class="terms-content">
        <div class="terms-texts">
            ...
            <p>A sua privacidade é importante para nós. É política do PathPals respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="../">PathPals</a>, e outros sites que possuímos e operamos.</p>
            ...
            <p class="terms-text-bold">Compromisso do Utilizador:</p>
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do PathPals, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
            </ul>

            <p class="terms-text-bold">Mais informações:</p>

            <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
            <p>- Esta política é efetiva a partir de 15 July 2024 13:22</p>
        </div>
    </div>
</body>
</html>