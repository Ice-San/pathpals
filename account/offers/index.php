                        ...
                        <div class="form-list-dates">
                            ...
                            <div class="form-list-date">
                                ...
                                <?php 
                                    ...
                                    echo '<input id="timeToBtn" type="datetime-local" name="offerToTime" maxlength="100" required value="'. $minTimeDate .'T'. $minTimeHour .'" min="'. $minTimeDate .'T'. $minTimeHour .'" max="'. $minTimeDate .'T23:59" />';
                                ?>
                            </div>
